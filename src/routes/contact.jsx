function Contact() {
    return (
        <>
            <section class="relative z-10 overflow-hidden bg-white dark:bg-dark" >
            <div class="container mx-auto">
                <div class="flex flex-wrap -mx-4 lg:justify-between">
                    <div class="w-full px-5 lg:w-1/2 xl:w-6/12 ">
                        ...
                        <p
                            ...
                            >
                            Comunicate directamente con nosotros para proporcionarte ayuda en lo que desees, la atención al cliente es nuestra prioridad.
                        </p>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base text-body-color dark:text-dark-6">
                                    Paseo de la Reforma, Colonia Roma.
                                </p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                        <div
                        class="relative p-8 bg-white rounded-lg sm:p-12 border-[1px] border-gray-200"
                        >
                        <form>
                            <div class="mb-6">
                                <input
                            ...
                            <div>
                                <button
                                    type="submit"
                                    class="w-full p-3 transition border rounded border-primary bg-primary hover:bg-gray-100"
                                    >
                                Enviar Mensaje
                                </button>
                            </div>
